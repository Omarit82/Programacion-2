...
public interface SimpleList {
    ...
    /*Agrega todos los elementos de la lista otherList pasada como parámetro
    ...
    /*Retorna la posición (índice) en la que se encuentra el objeto element
    pasado como parámetro. Si el objeto no existe en la lista, retorna -1 */
}
